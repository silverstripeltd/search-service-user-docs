...
-   **Engine** means the core software component responsible for executing search queries, indexing content, and generating search results. For more information, see [Engines and Schema](/features/engines-and-schema)
