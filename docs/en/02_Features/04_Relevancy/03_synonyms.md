...
You can configure synonyms using the API or via the Silverstripe Search Admin module that comes with the SDK - refer to the [Developer's guide](/developers-guide) for more information and installation instructions.
