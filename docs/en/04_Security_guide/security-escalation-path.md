title: Security escalation path
...
-   Securely email [security@silverstripe.com](mailto:security@silverstripe.com)

<div class="callout callout-info" markdown="1">
If you find security vulnerabilities in the Silverstripe CMS modules supported by Silverstripe, follow responsible disclosure documented in [Issues and Bug Reports](https://docs.silverstripe.org/en/5/contributing/issues_and_bugs/#reporting-security-issues).

You can find the list of supported modules in [Supported modules](https://docs.silverstripe.org/en/5/project_governance/supported_modules/).
